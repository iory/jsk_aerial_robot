...
class GimbalrotorROSRobotInterface(ROSRobotInterfaceBase):
    ...
    **kwargs
    ...
    def torque_states(self):
        ...
        -------
        dict
            ``{joint name: bool}``, see ``ArmServoTorque.states``.
        """
        return self.servo_torque.states()
    ...
    def torque_off(self, joint_names=None, timeout=2.0):
        ...
        """
        return self.servo_torque.off(joint_names, timeout)
    ...
    def torque_on(self, joint_names=None, timeout=2.0):
        ...
        """
        return self.servo_torque.on(joint_names, timeout)
